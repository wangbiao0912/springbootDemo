...
public class FfmepgTest {
  ...
  public void test1(){
    ...
    //    String path="/Users/wangbiao/Downloads/temp2/test.mp4";
//    boolean s=screenImage(ffmepgPath,path,imgPath+"out%d.jpg","350","240");
//    Thread.sleep(60000);
...
//    headers.set("Accept-Encoding", "GZIP");
   ...
   * @return
   */
  public  boolean screenImage(String ffmpegPath, String upFilePath, String mediaPicPath, String width, String height) {
